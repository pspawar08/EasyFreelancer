...
"./files/webimages/${e.candidateresume}"
            width="210" height="250">
             ...
             <a href="./files/webimages/${e.candidateresume}" class="download-button" download="EasyFreelancer Resume.PDF" style="background-color:#457b9d;padding:5px; color:#fff;">Download Resume
...
"./files/webimages/${ef.candidateresume}"
            width="250" height="250">
             ...
             <a href="./files/webimages/${ef.candidateresume}" class="download-button" download="EasyFreelancer Resume.PDF" style="background-color:#457b9d;padding:5px; color:#fff;">Download Resume
